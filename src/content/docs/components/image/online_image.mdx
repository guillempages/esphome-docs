...
> [!NOTE]
> using `AUTO` format will add the libraries and functionality required to decode all supported formats; which will increase the ROM size. If you know beforehand which format the downloaded images will have, it is better to specify the format explicitly.
